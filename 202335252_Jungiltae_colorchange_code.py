...
def extract_regions(image, cloth_lower, cloth_upper, bg_lower, bg_upper):
    ...
    cloth_mask_1 = cv2.inRange(hsv, cloth_lower[0], cloth_upper[0])  
    cloth_mask_2 = cv2.inRange(hsv, cloth_lower[1], cloth_upper[1])  
    cloth_mask = cv2.bitwise_or(cloth_mask_1, cloth_mask_2)  
...
def main():
    ...
    cloth_lower = [np.array([140, 50, 50]), np.array([170, 50, 50])]  
    cloth_upper = [np.array([170, 255, 255]), np.array([180, 255, 255])]  

   
    bg_lower = np.array([0, 0, 0])  
    bg_upper = np.array([180, 50, 50])  
